...
async function seedDatabase() {
  try {
    ...
    const cocktailsData = [
      ...
      { name: 'Old Fashioned', description: 'Un cocktail classique à base de whisky, de sucre, d\'eau et d\'amers.', instructions: ['Mélanger le whisky, le sucre, l\'eau et les amers', 'Servir avec une tranche d\'orange'], image_url: 'https://www.simplyrecipes.com/thmb/s_de1Nuw4ULiHNECVHOCBY5u5Wk=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/__opt__aboutcom__coeus__resources__content_migration__simply_recipes__uploads__2020__01__Old-Fashioned-Cocktail-LEAD-5-1024x681-aa81a798a156453d80d1f7d41de893ff.jpg', ingredients: [{ name: 'Whisky', quantity: 50, unit: 'ml' }, { name: 'Sucre', quantity: 1, unit: 'morceau' }, { name: 'Eau', quantity: 10, unit: 'ml' }, { name: 'Amers', quantity: 2, unit: 'traits' }] },
    ...
    const bar = new Bar({
      ...
      image_url: 'https://images.unsplash.com/photo-1543007630-9710e4a00a20?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Y29tcHRvaXIlMjBkZSUyMGJhcnxlbnwwfHwwfHx8MA%3D%3D',
      location: {
        type: 'Point',
